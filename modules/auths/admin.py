...
class AccountAdmin(UserAdmin):
    ...
    fieldsets = (
        ("Información de Usuario", {"fields": ("username", "password")}),
    ...
    add_fieldsets = (
        ...
        (
            ...
            {"classes": ("wide",), "fields": ("first_name", "last_name", "email", "phone_number")},
        ),
        (
            "Compañía y Configuración",
            {"classes": ("wide",), "fields": ("company", "status", "rol", "is_active", "is_staff")},
        ),
    )
